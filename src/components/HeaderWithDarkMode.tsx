...
export default function HeaderWithDarkMode() {
  ...
  return (
    <>
      <header className={`mb-6 md:static sticky top-0 z-30 md:bg-transparent bg-white dark:bg-[#0A0A0A] md:dark:bg-transparent transition-shadow ${isScrolled ? 'shadow-md' : ''} safe-area-top md:px-6`}>
        <div className="mb-4">
