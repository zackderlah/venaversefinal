            ...
            {canEdit && (
              <div className="mt-2 flex items-center space-x-3">
                <Link 
                  ...
                  className="text-xs lowercase font-semibold text-blue-600 hover:underline whitespace-nowrap"
                >
                  edit review
                </Link>
                <button 
                  onClick={e => { e.stopPropagation(); e.preventDefault(); handleDelete(e); }}
                  className="text-xs lowercase font-semibold text-red-600 hover:underline whitespace-nowrap"
                >
                  delete
                </button>
              </div>
