...
export default function BooksPage() {
  ...
  const filteredByViewMode = viewMode === 'my' && currentUser
    ? allBookReviews.filter(review => review.userId === currentUser.id)
    : allBookReviews;
      ...
      <section>
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6 text-lg lowercase">
          {viewMode === 'my' 
            ...
            : `a collection of thoughts and ratings for books i've read.`}
        </p>
            ...
            {sortedAndFilteredReviews.length > 0 ? (
              ...
              <p className="text-center text-gray-500 lowercase">
                {viewMode === 'my' && !currentUser 
                  ...
                  : (viewMode === 'my' ? 'you haven\'t written any book reviews yet.' : 'no book reviews found.')}
              </p>
            )}
          </div>
        )}
